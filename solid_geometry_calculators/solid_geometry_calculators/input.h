...
//return an input char of an alphabet or a digit
...
//return an integer where at the start and greater than or lesser than 
...
//return an input integer within range from startRange to endRange
...
//return an input double where posNeg is positive (true) or negative (false)
...
//return an input double within range, startRange and endRange
